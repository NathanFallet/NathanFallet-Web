        ...
        <div class="primary col-lg-8 col-12">
            ...
            <section class="latest section">
                <div class="section-inner">
                    ...
                    <h3 class="title"><a href="/project/' . $dn['id'] . '">' . $dn['name'] . '</a></h3>
                    <p class="summary">' . $dn['description_little'] . '</p>
                    <div class="featured-image has-ribbon">
                        <a href="/project/' . $dn['id'] . '">
                ...
                <hr class="divider" />';
                    ...
                    <a class="col-md-4 col-12" href="/project/' . $dn['id'] . '">
                    <img class="img-fluid project-image" src="' . $dn['img'] . '" alt="' . $dn['name'] . '" />
                    </a>
                    <div class="desc col-md-8 col-12">
                        <h3 class="title"><a href="/project/' . $dn['id'] . '">' . $dn['name'] . '</a></h3>
                        <p class="mb-2">' . $dn['description_little'] . '</p>
                        <p><a class="more-link" href="/project/' . $dn['id'] . '"><i class="fas fa-external-link-alt"></i>Find out more</a></p>
                    </div><!--//desc-->
                </div>';
                            }
                        }
                ...
                <div class="section-inner">
                    ...
                    <div class="content">
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fas fa-link"></i><span class="sr-only">Website:</span><a href="/">nathanfallet.me</a></li>
