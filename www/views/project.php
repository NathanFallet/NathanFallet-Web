...
?>
					<p><a href="<?php echo $url.'project/'.$project['id'].'/download'; ?>" class="btn btn-success">Download</a></p>
					<p>Downloads: <?php echo $project['downloads']; ?></p>
<?php
...
<?php
		...
		if(!empty($links[0])){
?>
					<p><a href="<?php echo $links[0]; ?>" target="_blank"><img src="<?php echo $url; ?>img/google-play-badge.png" style="max-width: 80%;"/></a></p>
<?php
		}
		if(!empty($links[1])){
?>
					<p><a href="<?php echo $links[1]; ?>" target="_blank"><img src="<?php echo $url; ?>img/app-store-badge.png" style="max-width: 80%;"/></a></p>
<?php
		}
	}
}
...
?>
					...
					echo 'Discover '.$project['name'].' by @NathanFallet - '.$url.'project/'.$project['id'];
